...
```bash
sudo tcpreplay -i ens33 !!!important!!! check your internet interface and change it if needed  --topspeed pkt.TCP.synflood.spoofed.pcap
```
...
-All SYN packets have the same length (40 bytes), which strongly 
