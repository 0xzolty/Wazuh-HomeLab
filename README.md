...
- All SYN packets share a similar TTL (bigger if target is closer smaller if hes far away) value, indicating 
  the attack originated from a single source using IP spoofing 
...
-All SYN packets have the same length (60 bytes), which strongly 
  suggests they were generated by a single tool rather than 
...
- Attack was orginaly commited from ~37 600 different spoofed ips 
...
<img width="1647" height="235" alt="image" src="https://github.com/user-attachments/assets/ea29b1d9-516b-49d7-a07f-56bd7804e528" />
